...
This version is the same as my 2D animation, but allows for some interactivity.
The rulesets are no longer checked, so the rules can create images that eventually result in 1 color
But now you can click to create colors.
*/
